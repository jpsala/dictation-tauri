...
describe("Settings host window", () => {
  it("reuses the preconfigured settings WebView and hides it on close", () => {
    ...
    expect(libSource).toContain("settings_window::hide_settings_window");
    ...
    expect(settingsSource).toContain("hide_settings_window_for_app");

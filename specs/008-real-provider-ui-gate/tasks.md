# Tasks: Real Provider UI Gate

- [X] T001 Add adapter test proving default submit remains dry-run and explicit real mode sends `mode: real` + `allowProviderCall: true`.
- [X] T002 Add the adapter option for explicit host request mode without changing provider-free defaults.

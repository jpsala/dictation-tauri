...
1. Adapter mock para MVP 1 y tests de pipeline.
2. Adapter directo local para MVP 2, leyendo variables de entorno locales o `.env` propio ignorado.
...
- Definir si el adapter directo vive en Rust/Tauri, Node script de benchmark o ambos por fases.

...
- Settings y onboarding usan ventanas Tauri distintas (`settings` y `account-setup`); onboarding ya no puede dejar la WebView de Settings navegada a `?surface=onboarding`.

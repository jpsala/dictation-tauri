...
- 2026-07-24 selection recovery release: source `main` pusheado en `aaeb496ef1de83519791810fab143d26ef2b5343`; checks 47 archivos/249 tests focales, frontend, Rust fmt/check/test compile, Worker 156/156 y NSIS verdes. Prerelease `fixvox-tauri-v0.1.0-20260724171409`: installer unsigned `29,568,485` bytes, SHA-256 local/publicado/redescargado `b79d531ea963c7d1dceaff150a36f2da3d727400417b7fead2dbbec85e9dcabe`. URL directa: `https://github.com/jpsala/fixvox-releases/releases/download/fixvox-tauri-v0.1.0-20260724171409/Fixvox-Tauri-Setup.exe`. No hubo deploy cloud ni provider call; queda pendiente la instalación física en la otra PC.
- 2026-07-24 prompt runtime parity release: source `main` commiteado/pusheado en `4db04f8`; el bundle API reproducido desde ese commit coincide con runtime productivo `89750e99f55f7d01`. `npm run release:windows` pasó 47 archivos/249 tests focales, frontend, Rust fmt/check/test compile y NSIS. Prerelease `fixvox-tauri-v0.1.0-20260724210739`: installer unsigned `29,575,899` bytes, SHA-256 local/publicado/redescargado `92657b4b8713389992849b58fdb4474ee4942eaab9f50da73e6cddb2a7963443`. URL directa: `https://github.com/jpsala/fixvox-releases/releases/download/fixvox-tauri-v0.1.0-20260724210739/Fixvox-Tauri-Setup.exe`. Runtime VPS, installer y checksum quedaron publicados; no se instaló ni se hizo smoke físico.
- 2026-07-25 skins/first-run release: source `main` quedó en `5d1c649` (incluye el formateo Rust final); `npm run release:windows` pasó 47 archivos/254 tests focales, frontend, Rust fmt/check/test compile y NSIS. Prerelease `fixvox-tauri-v0.1.0-20260725141704`: installer unsigned `29,584,245` bytes, SHA-256 `547aff2653750ac30ad1017c73ac4948ca87b59b8324a111d9209183944ba5da`. Instalación local silenciosa exit `0` en `%LOCALAPPDATA%\Fixvox Tauri\dictation-tauri.exe`. Release: `https://github.com/jpsala/fixvox-releases/releases/tag/fixvox-tauri-v0.1.0-20260725141704`; descarga: `https://github.com/jpsala/fixvox-releases/releases/download/fixvox-tauri-v0.1.0-20260725141704/Fixvox-Tauri-Setup.exe`.
- 2026-07-25 verificación final del instalador: se reconstruyó desde `origin/main` en `aad6fb8` sin cambios de producto posteriores a `5d1c649`; pasó 47 archivos/254 tests focales, frontend, Rust fmt/check/test compile y NSIS. El prerelease definitivo es `fixvox-tauri-v0.1.0-20260725145312`, installer unsigned `29,578,811` bytes, SHA-256 local/remoto `e5e228eef5c17643b3a36eccd407c8c417aadc6b2a89c49c04f5f73daacc0239`, instalado localmente con exit `0`; el ejecutable contiene las tres etiquetas de skin y el menú `Dock skin`. Release: `https://github.com/jpsala/fixvox-releases/releases/tag/fixvox-tauri-v0.1.0-20260725145312`; descarga: `https://github.com/jpsala/fixvox-releases/releases/download/fixvox-tauri-v0.1.0-20260725145312/Fixvox-Tauri-Setup.exe`.
- 2026-07-25 hotfix de estado confuso instalado/publicado: commit fuente `f418160`; 47 archivos/255 tests focales, frontend, Rust fmt/check/test compile y NSIS. El hotfix hace que Stop/Cancel fuera de tiempo sea un no-op seguro, evita mostrar `Needs attention` por una carrera de transición y no muestra Stop durante `arming`. Prerelease `fixvox-tauri-v0.1.0-20260725210647`, installer unsigned `29,580,466` bytes, SHA-256 local/remoto `614d1a215dd0dddf0be123070680139638429324fa39d62e905c01db1e8c26f2`; instalación local exit `0`. Release: `https://github.com/jpsala/fixvox-releases/releases/tag/fixvox-tauri-v0.1.0-20260725210647`; descarga: `https://github.com/jpsala/fixvox-releases/releases/download/fixvox-tauri-v0.1.0-20260725210647/Fixvox-Tauri-Setup.exe`.
- 2026-08-19 release Win+Space: source code commit `3697811981df99db571741bc7aa4833810046f21` fue pusheado a `origin/main`; versión `0.1.0`; prerelease unsigned `fixvox-tauri-v0.1.0-20260819130850` publicada en `jpsala/fixvox-releases`. `npm run release:windows` pasó 55 archivos/327 tests focales, frontend build, `cargo fmt --check`, `cargo check`, `cargo test --no-run` y bundle NSIS. Installer `Fixvox-Tauri-Setup.exe`: `30,156,060` bytes, SHA-256 `d7a09415ed33f4400d3461138e3980ea56ceb003a7a87a9e1e7ad86cdeb3daa7`; checksum y bytes del asset publicado/redescargado coinciden. Instalación silenciosa desde la redescarga: exit `0`, versión instalada `0.1.0`, ejecutable `%LOCALAPPDATA%/Fixvox Tauri/dictation-tauri.exe`, entrada de desinstalación presente. Startup smoke instalado provider-free: proceso vivo, WebView principal cargado, side effects de startup suprimidos y sin marcadores de provider/paste/audio; el helper histórico además observó la ventana esperada `Fixvox Setup`, por lo que su aserción de “cero ventanas visibles” no se tomó como criterio del onboarding actual. La app instalada quedó viva en el path canónico. Release: `https://github.com/jpsala/fixvox-releases/releases/tag/fixvox-tauri-v0.1.0-20260819130850`; descarga directa: `https://github.com/jpsala/fixvox-releases/releases/download/fixvox-tauri-v0.1.0-20260819130850/Fixvox-Tauri-Setup.exe`. No hubo deploy cloud, login, provider STT, micrófono, audio, clipboard, selección ni paste.

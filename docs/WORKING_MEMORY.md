...
- Admin/cloud operativo. Worker activo `df416730-61b8-4222-ab5f-282879251db9` desde el 2026-07-18; rechaza rebinding de `deviceId` en register/activate con `409 device_binding_conflict`; health público 200/OK. Admin VPS desplegado y healthz OK; Pi Chat volvió al sidebar en `36daed2` y `e7c59eb` corrigió el overflow narrow apilando actividad y envolviendo código. Tests Admin 14/14, smoke y screenshot `871×625` verdes; Browser confirmó assets productivos; backup follow-up `20260718-010830.tar.gz`. No mutar prod sin permiso.

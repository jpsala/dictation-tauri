...
- Admin/cloud operativo. Worker activo `df416730-61b8-4222-ab5f-282879251db9` desde el 2026-07-18; rechaza rebinding de `deviceId` en register/activate con `409 device_binding_conflict`; health público 200/OK. Admin VPS desplegado con backup `20260718-000036.tar.gz` y healthz OK; no mutar prod sin permiso.

...
- Selection transform funciona nuevamente para JP. El hardening fail-closed de recovery quedó publicado desde `aaeb496` en la prerelease `fixvox-tauri-v0.1.0-20260724171409`; la revisión integral de errores visibles sigue pendiente en `docs/tracks/user-facing-error-experience-review.md`, junto con las deudas separadas de account linkage y cache local de acceso.

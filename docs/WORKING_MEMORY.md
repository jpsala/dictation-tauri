...
- Admin/cloud operativo. Worker activo `df416730-61b8-4222-ab5f-282879251db9` desde el 2026-07-18; rechaza rebinding de `deviceId` en register/activate con `409 device_binding_conflict`; health público 200/OK. Admin VPS desplegado y healthz OK; Pi Chat volvió al sidebar en `36daed2`, validado por tests/smoke y Browser contra el asset productivo; backup follow-up `20260718-005602.tar.gz`. No mutar prod sin permiso.

...
| Calidad de transcripción, comparar modelos/prompts, corpus humano, WER, postprocess, costo/latencia | [Calidad y evaluación de transcripción](topics/transcription-quality-and-evaluation.md) y [programa activo](tracks/transcription-quality-program.md) | Autoridad durable y ejecución priorizada para recuperar Fixvox, medir STT/materialización y promover rutas de calidad con evidencia. |
...
| Norte, AOS, sistema agentic, memoria viva, audit de contexto | [Agentic OS (AOS)](topics/agentic-os.md) | Operación del sistema agentic documental del proyecto. |
...
| [ASSISTANT_RULES.md](ASSISTANT_RULES.md) | Fronteras locales para datos y secretos. |
